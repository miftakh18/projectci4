                ...
                <form id="<?= $idform; ?>">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="hid" id="hid" class="custom-select">
                                ...
                                <?php foreach ($this->HeaderAll() as $key => $header) : ?>
                                    <option value="<?= $header['hid']; ?>" <?= $header['hid'] == 1 ? 'hidden' : ''; ?>><?= $header['nama_head'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span><small>Search Font <a href="https://fontawesome.com/v5/search" target="_blank">FontAwesome5</a></small></span>
                        </div>
                        <div class="form-group">
                            <label for="">Deskripsi </label>
            ...
            <div class="modal-content">
                ...
                <form id="<?= $idform; ?>">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Header </label>
                            <select name="hid" id="hid" class="custom-select <?= $idform; ?>">
                                <option value="">Pilih Header</option>
                                <?php foreach ($this->HeaderAll() as $key => $header) : ?>
                                    <option value="<?= $header['hid']; ?>" <?= $header['hid'] == 1 ? 'hidden' : ''; ?>><?= $header['nama_head'] ?></option>
                                <?php endforeach ?>
                        ...
                        <div class="form-group">
                            <label for="">Menu </label>
                            <select name="mid" id="mid" class="custom-select mid<?= $idform; ?>">
                                <option value="">Pilih Menu</option>
                            </select>
                            <span id="load" class="load<?= $idform; ?>"></span>
                        </div>
                        <div class="form-group">
                            <label for="">Nama Submenu </label>
                            <input type="text" class="form-control form-control-user" id="nama_submenu" name="nama_submenu">
                        </div>
                        <div class="form-group">
                            <label for="">Link </label>
                            <input type="text" class="form-control form-control-user" id="href" name="href">
